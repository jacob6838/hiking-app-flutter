...
Map<String, dynamic> _$LocationStatusToJson(LocationStatus instance) => <String, dynamic>{};

_$_LocationStatus _$_$_LocationStatusFromJson(Map<String, dynamic> json) {
  return _$_LocationStatus(
    latitude: (json['latitude'] as num)?.toDouble() ?? 0.0,
    longitude: (json['longitude'] as num)?.toDouble() ?? 0.0,
    accuracy: _$enumDecodeNullable(_$LocationAccuracyTypeEnumMap, json['accuracy']) ?? LocationAccuracyType.low,
...
Map<String, dynamic> _$_$_LocationStatusToJson(_$_LocationStatus instance) => <String, dynamic>{
